...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[4] = LAYOUT_ortho_4x12(KC_GRV, KC_BRID, KC_BRIU, KC_MRWD, KC_MPLY, KC_MFFD, KC_MSTP, KC_7, KC_8, KC_9, KC_MINS, KC_UNDS, KC_INS, EMAIL_A, NAME_F, NAME_L, CITY, GMAIL, HTTPS, KC_4, KC_5, KC_6, KC_PPLS, KC_DEL, KC_TRNS, EMAIL_B, KC_F8, COPYALL, PASTEALL, KC_F11, KC_F12, KC_1, KC_2, KC_3, KC_SLSH, KC_SFTENT, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, MO(5), KC_TRNS, KC_TRNS, KC_TRNS, KC_0, KC_DOT, KC_PAST, KC_EQL),
